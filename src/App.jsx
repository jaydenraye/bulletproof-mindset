...
const HR_AI_PROMPT = `You are Alethe, the AI guide for the HR Manager section of Bulletproof Mindset — a workplace mental health platform built on the methodology of Jay, a Life Education Specialist with 25+ years of experience.
      ...
      <div style={{ fontFamily: "'Georgia','Times New Roman',serif", background: '#0a1420', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
        <div style={{ maxWidth: 360, width: '100%', textAlign: 'center' }}>
          ...
          <input
            ...
            style={{ width: '100%', padding: '12px 16px', borderRadius: 12, fontSize: 14, background: 'rgba(255,255,255,0.06)', border: `1px solid ${gateError ? '#e86a6a' : 'rgba(100,160,255,0.3)'}`, color: '#e8f0fe', outline: 'none', fontFamily: "'Georgia',serif", textAlign: 'center', letterSpacing: '0.1em', marginBottom: 12, boxSizing: 'border-box', transition: 'border-color 0.2s' }}
          />
          {gateError && <p style={{ color: '#e86a6a', fontSize: 13, marginBottom: 12 }}>Incorrect code. Please try again.</p>}
          <button onClick={handleGateSubmit} style={{ width: '100%', padding: '12px 24px', borderRadius: 12, fontSize: 14, background: 'linear-gradient(135deg, #1a4a8a, #2a6acc)', border: 'none', color: '#fff', cursor: 'pointer', fontFamily: "'Georgia',serif", letterSpacing: '0.05em' }}>Enter</button>
        </div>
      </div>
    );
  }
